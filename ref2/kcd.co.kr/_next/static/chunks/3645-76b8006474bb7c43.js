(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3645],
  {
    ...
    9164: function (e, t, s) {
      ...
      function g({
        ...
        if (
          ...
          n.includes("children") && t && m && p.virtual.enabled
            ...
            return (
              Object.keys(c).forEach((i) => {
                "undefined" !== typeof e[i] &&
                  (d.indexOf(i) >= 0
                    ? r(e[i])
                      ? ((s[i] = {}), (l[i] = {}), a(s[i], e[i]), a(l[i], e[i]))
                      : ((s[i] = e[i]), (l[i] = e[i]))
                    : 0 === i.search(/on[A-Z]/) && "function" === typeof e[i]
                    ? t
                      ? (n[`${i[2].toLowerCase()}${i.substr(3)}`] = e[i])
                      : (s.on[`${i[2].toLowerCase()}${i.substr(3)}`] = e[i])
                    : (o[i] = e[i]));
              }),
              ["navigation", "pagination", "scrollbar"].forEach((e) => {
                !0 === s[e] && (s[e] = {}), !1 === s[e] && delete s[e];
              }),
              { params: s, passedParams: l, rest: o, events: n }
            );
          })(S),
          { slides: R, slots: V } = m(w),
          W = () => {
            M(!P);
          };
        Object.assign(B.on, {
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                B.virtual
                  ...
                  ? R.map((e) => n.cloneElement(e, { swiper: _.current }))
                  : (function (e, t, s) {
                      const i = t.map((t, s) =>
                        n.cloneElement(t, {
                          swiper: e,
                      ...
                      for (let n = 0; n < a; n += 1) {
                        ...
                        o.push(r(i[e], n, "append")),
                          l.unshift(r(i[i.length - e - 1], n, "prepend"));
                      }
    ...
    3440: function (e, t, s) {
      ...
      var L = {
        ...
        updateSlides: function () {
          ...
          for (let S = 0; S < p; S += 1) {
            ...
            const i = c.eq(S);
            if (
              (T && e.grid.updateSlide(S, i, p, t), "none" !== i.css("display"))
            ) {
        ...
        updateSlidesProgress: function (e = (this && this.translate) || 0) {
          ...
          for (let l = 0; l < n.length; l += 1) {
            ...
            ((p >= 0 && p < t.size - 1) ||
              ...
              n.eq(l).addClass(s.slideVisibleClass)),
              (e.progress = i ? -d : d),
      ...
      function z({ swiper: e, runCallbacks: t, direction: s, step: n }) {
      ...
      var I = {
        loopCreate: function () {
          ...
          for (let a = 0; a < o.length; a += 1)
            i.append(g(o[a].cloneNode(!0)).addClass(s.slideDuplicateClass));
          for (let a = l.length - 1; a >= 0; a -= 1)
            i.prepend(g(l[a].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
        loopFix: function () {
          const e = this;
      ...
      function N(e) {
        ...
        if (!s.allowTouchMove)
          return (
            g(d.target).is(n.focusableElements) || (s.allowClick = !1),
            void (
              n.isTouched &&
              (Object.assign(r, {
                startX: p,
      ...
      function G(e) {
        ...
        if (c > n.longSwipesMs) {
          ...
          "next" === t.swipeDirection &&
            (g >= n.longSwipesRatio
              ? t.slideTo(n.rewind && t.isEnd ? h : u + b)
              : t.slideTo(u)),
      ...
      var W = {
        attachEvents: function () {
          ...
          (e.onTouchStart = D.bind(e)),
            ...
            (e.onClick = j.bind(e)),
            n.touch && !H && (t.addEventListener("touchstart", R), (H = !0)),
            V(e, "on");
        },
      ...
      function se({ swiper: e, extendParams: t, on: s, emit: n }) {
        function i(t) {
          let s;
          return (
            t &&
